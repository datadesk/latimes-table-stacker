...
Quickly publish spreadsheets as interactive tables.
...
* "ProPublica's News Application Desk":http://www.propublica.org/nerds, and particularly "Jeff Larson":https://github.com/thejefflarson, who developed the Ruby libraries that got this ball rolling, namely: "table-fu":https://github.com/propublica/table-fu and "table-setter":https://github.com/propublica/table-setter.
* Chris Amico, who did the noble work of "porting table-fu to Python":https://github.com/eyeseast/python-tablefu.

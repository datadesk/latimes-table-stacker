...
You'll run the same _loadtable_ command from step 5, but drop the host option. It will post to your live site by default, so it's unnecessary this time around.

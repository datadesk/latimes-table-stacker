...
** I don't know why, but "newer versions won't work in my preferred OS, Ubuntu 10.10":http://www.codigomanso.com/en/2010/05/google-app-engine-en-ubuntu-10-4-lucid-lynx/.
...
It's not required, but I recommend creating a virtual environment to store your app in. I like to do this with the Python module "virtualenv":":http://pypi.python.org/pypi/virtualenv, which creates a walled-off garden for the Python code in this project to work without distraction from the outside world.
...
Then jump in and get ready to work.

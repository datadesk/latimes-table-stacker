...
In the _project_ folder you will find a file called _app.yaml_. It contains the basic configuration for your Google App Engine site. You only need to make one little change: Replace _my-table-stacker_ with the application id you registered earlier.

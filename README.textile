...
Go to "https://appengine.google.com/":https://appengine.google.com/. Don't download the SDK. Don't read the docs (yet). Just create an account and mint a new application with a name like _my-table-stacker_.

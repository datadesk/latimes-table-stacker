...
h3. *04. Launch a test version of the site on your computer*
...
Note that you'll see me using _python2.5_ throughout, instead of the usual _python_ command. This is because I work in Ubuntu and I've found that Google App Engine "is not compatiable with newer versions of Python":http://www.codigomanso.com/en/2010/05/google-app-engine-en-ubuntu-10-4-lucid-lynx/. I suspect is is the case of other operating systems, but I'm not sure. So, I'd recommend using _python2.5_ but, as always, your mileage may vary.
